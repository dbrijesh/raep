...
- **Net-new bootstrap** (`--mode new`, default when `.planning/` is absent): produces PROJECT.md + REQUIREMENTS.md + ROADMAP.md + STATE.md from synthesized doc content, delegating final generation to `rapidx-roadmapper`.
...
<execution_context>
@~/.claude/get-things-done/workflows/ingest-docs.md
