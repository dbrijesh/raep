...
Post-mortem investigation for failed or stuck RapidX workflows. Analyzes git history,
...
3. {Recovery command if applicable — e.g., `/rapidx:resume-work`, `/rapidx:execute-phase N`}

---

*Report generated by `/rapidx:forensics`. All paths redacted for portability.*
```
