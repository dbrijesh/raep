...
```bash
rapidx-sdk query validate.health $REPAIR_FLAG
```
...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /rapidx:health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /rapidx:new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /rapidx:health --repair
```
</step>
...
```
Would you like to run /rapidx:health --repair to fix N issues automatically?
```
...
```bash
rapidx-sdk query validate.health
```
