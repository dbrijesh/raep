...
Use /rapidx:quick for anything that needs multi-step planning or research.
</purpose>
...
```
This looks like it needs planning. Use /rapidx:quick instead:
  /rapidx:quick "{task description}"
```
...
- If the task takes more than 3 file edits, STOP and redirect to /rapidx:quick
- If you're unsure how to implement it, STOP and redirect to /rapidx:quick
</guardrails>
