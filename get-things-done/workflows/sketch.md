...
Companion to `/rapidx:sketch-wrap-up`.
</purpose>

<required_reading>
Read all files referenced by the invoking prompt's execution_context before starting.

@~/.claude/get-things-done/references/sketch-theme-system.md
@~/.claude/get-things-done/references/sketch-variant-patterns.md
@~/.claude/get-things-done/references/sketch-interactivity.md
@~/.claude/get-things-done/references/sketch-tooling.md
</required_reading>
...
```bash
rapidx-sdk query commit "docs(sketch-NNN): [winning direction] — [key visual insight]" .planning/sketches/NNN-descriptive-name/ .planning/sketches/MANIFEST.md
```
...
**Also available:**
- `/rapidx:plan-phase` — start building the real UI
- `/rapidx:explore` — continue exploring the concept
- `/rapidx:spike` — spike technical feasibility of a design pattern
