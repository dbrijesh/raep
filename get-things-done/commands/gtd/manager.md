...
**Creates/Updates:**
- No files created directly — dispatches to existing RapidX commands via Skill() and background Task agents.
...
Project context, phase list, dependencies, and recommendations are resolved inside the workflow using `rapidx-sdk query init.manager`. No upfront context loading needed.
</context>
