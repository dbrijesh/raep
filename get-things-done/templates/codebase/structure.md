...
**New Template:**
- Implementation: `get-things-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `get-things-done/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/get-things-done/workflows/{name}.md`

**New Reference Document:**
- Implementation: `get-things-done/references/{name}.md`
