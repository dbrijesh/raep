...
- `rapidx-planner` — reads locked requirements to constrain plan scope
- `rapidx-verifier` — uses acceptance criteria as explicit pass/fail checks
...
*Phase: [XX-name]*
*Spec created: [date]*
*Next step: /rapidx:discuss-phase [X] — implementation decisions (how to build what's specified above)*
```
...
*Next step: /rapidx:discuss-phase 3 — implementation decisions (card layout, loading skeleton, etc.)*
```
...
*Spec created: 2025-01-20*
*Next step: /rapidx:discuss-phase 2 — implementation decisions (progress reporting, flag design, etc.)*
```
