...
> AI design contract generated by `/rapidx:ai-integration-phase`. Consumed by `rapidx-planner` and `rapidx-eval-auditor`.
...
> Researched by `rapidx-domain-researcher`. Grounds the evaluation strategy in domain expert knowledge.
...
> Fetched from official docs by `rapidx-ai-researcher`. Distilled for this specific use case.
...
> Written by `rapidx-ai-researcher`. Cross-cutting patterns every developer building AI systems needs — independent of framework choice.
