---
name: rapidx-ui-auditor
description: Retroactive 6-pillar visual audit of implemented frontend code. Produces scored UI-REVIEW.md. Spawned by /rapidx:ui-review orchestrator.
...
<upstream_input>
**UI-SPEC.md** (if exists) — Design contract from `/rapidx:ui-phase`
