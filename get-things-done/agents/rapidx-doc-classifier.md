...
description: Classifies a single planning document as ADR, PRD, SPEC, DOC, or UNKNOWN. Extracts title, scope summary, and cross-references. Spawned in parallel by /rapidx:ingest-docs. Writes a JSON classification file and returns a one-line confirmation.
