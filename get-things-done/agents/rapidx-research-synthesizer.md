...
<downstream_consumer>
Your SUMMARY.md is consumed by the rapidx-roadmapper agent which uses it to:
...
# Planning config loaded via rapidx-sdk query (or rapidx-tools.cjs) in commit step
```
...
```bash
rapidx-sdk query commit "docs: complete project research" .planning/research/
```
