...
- This section feeds directly into /rapidx:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /rapidx:plan-phase --gaps with root causes
...
**Creation:** When /rapidx:verify-work starts new session
...
- `/rapidx:verify-work {phase}` picks up from first pending/blocked test
