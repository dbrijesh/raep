...
```bash
AGENT_SKILLS_DEBUGGER=$(rapidx-sdk query agent-skills rapidx-debugger 2>/dev/null)
...
```bash
rapidx-sdk query commit "docs({phase_num}): add root causes from diagnosis" ".planning/phases/XX-name/{phase_num}-UAT.md"
```
</step>
