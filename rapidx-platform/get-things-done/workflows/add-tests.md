...
Users currently hand-craft `/rapidx:quick` prompts for test generation after each phase. This workflow standardizes the process with proper classification, quality gates, and gap reporting.
</purpose>
...
Example: `/rapidx:add-tests 12 focus on edge cases` → `$PHASE_ARG=12`, `$EXTRA_INSTRUCTIONS="focus on edge cases"`

If no phase argument provided:

```
ERROR: Phase number required
Usage: /rapidx:add-tests <phase> [additional instructions]
Example: /rapidx:add-tests 12
Example: /rapidx:add-tests 12 focus on edge cases in the pricing module
```
...
This command works on completed phases. Run /rapidx:execute-phase first.
```
Exit.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 RapidX ► ADD TESTS — Phase ${phase_number}: ${phase_name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
</step>
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 RapidX ► TEST GENERATION COMPLETE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```bash
rapidx-sdk query state-snapshot
```
...
{if bugs discovered:}
**Fix discovered bugs:** `/rapidx:quick fix the {N} test failures discovered in phase ${phase_number}`
...
**Also available:**
- `/rapidx:add-tests {next_phase}` — test another phase
- `/rapidx:verify-work {phase_number}` — run UAT verification
