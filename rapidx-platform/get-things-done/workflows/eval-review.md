<purpose>
Retroactive audit of an implemented AI phase's evaluation coverage. Standalone command that works on any RapidX-managed AI phase. Produces a scored EVAL-REVIEW.md with gap analysis and remediation plan.

Use after /rapidx:execute-phase to verify that the evaluation strategy from AI-SPEC.md was actually implemented. Mirrors the pattern of /rapidx:ui-review and /rapidx:validate-phase.
</purpose>

<required_reading>
@~/.claude/get-things-done/references/ai-evals.md
</required_reading>
...
```bash
AUDITOR_MODEL=$(rapidx-sdk query resolve-model rapidx-eval-auditor 2>/dev/null | jq -r '.model' 2>/dev/null || true)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 RapidX ► EVAL AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**State C** — No SUMMARY.md: Exit — "Phase {N} not executed. Run /rapidx:execute-phase {N} first."
...
Consider running /rapidx:ai-integration-phase {N} before implementation next time.
```
...
```markdown
Read ~/.claude/agents/rapidx:eval-auditor.md for instructions.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 RapidX ► EVAL AUDIT COMPLETE — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
{If PRODUCTION READY:}
  Next step: /rapidx:plan-phase (next phase) or deploy

{If NEEDS WORK:}
  Address critical gaps in EVAL-REVIEW.md, then re-run /rapidx:eval-review {N}
...
- [ ] rapidx-eval-auditor spawned with correct context
