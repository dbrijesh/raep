...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/rapidx:discuss-phase`.
...
Consider running /rapidx:discuss-phase {N} again to refine before planning.
```
