...
<execution_context>
@~/.claude/get-things-done/workflows/sketch-wrap-up.md
...
<process>
Execute the sketch-wrap-up workflow from @~/.claude/get-things-done/workflows/sketch-wrap-up.md end-to-end.
