...
<execution_context>
@~/.claude/get-things-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @~/.claude/get-things-done/workflows/pr-branch.md end-to-end.
</process>
