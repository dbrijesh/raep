...
<execution_context>
@~/.claude/get-things-done/workflows/spec-phase.md
@~/.claude/get-things-done/templates/spec.md
</execution_context>
...
<process>
Execute the spec-phase workflow from @~/.claude/get-things-done/workflows/spec-phase.md end-to-end.
