...
- `--path` — Target directory. Defaults to `~/rapidx-workspaces/<name>`
...
**After this command:** `cd` into the workspace and run `/gsd:new-project` to initialize Get Things Done.
</objective>
