...
<execution_context>
@~/.claude/get-things-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.claude/get-things-done/workflows/session-report.md end-to-end.
</process>
