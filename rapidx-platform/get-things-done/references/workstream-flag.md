...
GSD_SESSION_KEY=my-terminal-a rapidx-sdk query workstream.set feature-a
GSD_SESSION_KEY=my-terminal-a rapidx-sdk query state.json
GSD_SESSION_KEY=my-terminal-b rapidx-sdk query workstream.set feature-b
GSD_SESSION_KEY=my-terminal-b rapidx-sdk query state.json
