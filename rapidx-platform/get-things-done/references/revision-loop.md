...
|----------|---------------|---------------|-------|
| plan-phase | rapidx-planner | rapidx-plan-checker | Revision prompt via planner-revision.md |
| execute-phase | rapidx-executor | rapidx-verifier | Post-execution verification |
| discuss-phase | orchestrator | rapidx-plan-checker | Inline revision by orchestrator |
