...
<required_reading>
Read `~/.claude/get-things-done/references/ai-evals.md` before planning. This is your evaluation framework.
</required_reading>
...
Read AI-SPEC.md in full — Section 1 (failure modes), Section 1b (domain rubric ingredients from rapidx-domain-researcher), Sections 3-4 (Pydantic patterns to inform testable criteria), Section 2 (framework for tooling defaults).
