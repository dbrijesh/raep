...
```
#file:.github/copilot/agents/planner.md
Plan a new project: [describe what you want to build]
```

Or for phase planning:
```
#file:.github/copilot/agents/planner.md
Plan the next phase. Current state: [describe where you are]
```
