...
<execution_context>
@~/.claude/get-things-done/workflows/analyze-dependencies.md
</execution_context>
...
<process>
Execute the analyze-dependencies workflow from @~/.claude/get-things-done/workflows/analyze-dependencies.md end-to-end.
